        ...
        <div class="container-fluid">
            <ol class="breadcrumb__list">
                <li class="breadcrumb__item"><a
                        href="<?php echo get_field('link_san_pham') ;?>"><?php echo get_field('link_san_pham') ;?></a>
                </li>

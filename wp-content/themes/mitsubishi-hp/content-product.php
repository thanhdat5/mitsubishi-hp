				...
				<ul class="hp-pb-features">
					...
					?>
						<li class="hp-pb-feature">
							<img src="https://www.mitsubishi-motors.com.vn/w/wp-content/uploads/2022/04/pajero-sport-safety-icon.svg" alt="" />
					...
					?>
						<li class="hp-pb-feature">
							<img src="https://www.mitsubishi-motors.com.vn/w/wp-content/uploads/2022/04/pajero-sport-automatic-icon.svg" alt="" />
					...
					?>
						<li class="hp-pb-feature">
							<img src="https://www.mitsubishi-motors.com.vn/w/wp-content/uploads/2022/04/pejero-sport-electric-icon.svg" alt="" />
						...
						<div class="col-<?php echo $total_version == 1 ? '6' : $col_size; ?> col-md-<?php echo $total_version == 1 ? '6' : $col_size; ?> col-lg-<?php echo $total_version == 1 ? '6' : $col_size; ?>">
							<div class="hp-compare-model" id="CompareVersion1">
								<div class="hp-cm-image">
									...
									?>
										<img id="CompareVersion1Image1" class="w-100" src="<?php echo get_field('pb1_mau_1_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion1Image2" class="w-100" src="<?php echo get_field('pb1_mau_2_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion1Image3" class="w-100" src="<?php echo get_field('pb1_mau_3_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion1Image4" class="w-100" src="<?php echo get_field('pb1_mau_4_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion1Image5" class="w-100" src="<?php echo get_field('pb1_mau_5_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
								</div>
								...
								<div class="hp-cm-colors gap-1 d-flex">
									...
									if (get_field('pb1_mau_1_ten')) {
									?>
										<span id="CompareVersion1ColorCode1" style="background-color:<?php echo get_field('pb1_mau_1_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb1_mau_2_ten')) {
									?>
										<span id="CompareVersion1ColorCode2" style="background-color:<?php echo get_field('pb1_mau_2_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb1_mau_3_ten')) {
									?>
										<span id="CompareVersion1ColorCode3" style="background-color:<?php echo get_field('pb1_mau_3_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb1_mau_4_ten')) {
									?>
										<span id="CompareVersion1ColorCode4" style="background-color:<?php echo get_field('pb1_mau_4_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb1_mau_5_ten')) {
									?>
										<span id="CompareVersion1ColorCode5" style="background-color:<?php echo get_field('pb1_mau_5_ma'); ?>"></span>
									<?php
									}
									?>
								</div>
						...
						<div class="col-<?php echo $col_size; ?> col-md-<?php echo $col_size; ?>col-lg-<?php echo $col_size; ?>">
							<div class="hp-compare-model" id="CompareVersion2">
								<div class="hp-cm-image">
									...
									?>
										<img id="CompareVersion2Image1" class="w-100" src="<?php echo get_field('pb2_mau_1_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion2Image2" class="w-100" src="<?php echo get_field('pb2_mau_2_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion2Image3" class="w-100" src="<?php echo get_field('pb2_mau_3_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion2Image4" class="w-100" src="<?php echo get_field('pb2_mau_4_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion2Image5" class="w-100" src="<?php echo get_field('pb2_mau_5_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
								</div>
								...
								<div class="hp-cm-colors gap-1 d-flex">
									...
									if (get_field('pb2_mau_1_ten')) {
									?>
										<span id="CompareVersion2ColorCode1" style="background-color:<?php echo get_field('pb2_mau_1_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb2_mau_2_ten')) {
									?>
										<span id="CompareVersion2ColorCode2" style="background-color:<?php echo get_field('pb2_mau_2_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb2_mau_3_ten')) {
									?>
										<span id="CompareVersion2ColorCode3" style="background-color:<?php echo get_field('pb2_mau_3_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb2_mau_4_ten')) {
									?>
										<span id="CompareVersion2ColorCode4" style="background-color:<?php echo get_field('pb2_mau_4_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb2_mau_5_ten')) {
									?>
										<span id="CompareVersion2ColorCode5" style="background-color:<?php echo get_field('pb2_mau_5_ma'); ?>"></span>
									<?php
									}
									?>
								</div>
						...
						<div class="col-<?php echo $col_size; ?> col-md-<?php echo $col_size; ?> col-lg-<?php echo $col_size; ?>">
							<div class="hp-compare-model" id="CompareVersion3">
								<div class="hp-cm-image">
									...
									?>
										<img id="CompareVersion3Image1" class="w-100" src="<?php echo get_field('pb3_mau_1_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion3Image2" class="w-100" src="<?php echo get_field('pb3_mau_2_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion3Image3" class="w-100" src="<?php echo get_field('pb3_mau_3_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion3Image4" class="w-100" src="<?php echo get_field('pb3_mau_4_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
									<?php
									...
									?>
										<img id="CompareVersion3Image5" class="w-100" src="<?php echo get_field('pb3_mau_5_hinh_anh'); ?>" alt="" />
									<?php
									}
									?>
								</div>
								...
								<div class="hp-cm-colors gap-1 d-flex">
									...
									if (get_field('pb3_mau_1_ten')) {
									?>
										<span id="CompareVersion3ColorCode1" style="background-color:<?php echo get_field('pb3_mau_1_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb3_mau_2_ten')) {
									?>
										<span id="CompareVersion3ColorCode2" style="background-color:<?php echo get_field('pb3_mau_2_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb3_mau_3_ten')) {
									?>
										<span id="CompareVersion3ColorCode3" style="background-color:<?php echo get_field('pb3_mau_3_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb3_mau_4_ten')) {
									?>
										<span id="CompareVersion3ColorCode4" style="background-color:<?php echo get_field('pb3_mau_4_ma'); ?>"></span>
									<?php
									}
									?>
									<?php
									if (get_field('pb3_mau_5_ten')) {
									?>
										<span id="CompareVersion3ColorCode5" style="background-color:<?php echo get_field('pb3_mau_5_ma'); ?>"></span>
									<?php
									}
									?>
								</div>
					...
					<div class="accordion-item">
						...
						<div id="collapse1" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								...
								?>
									<div class="hp-compare-label">Mức tiêu hao nhiên liệu (Kết hợp/Đô thị/Ngoài đô thị)</div>
									<div class="row gx-5 justify-content-center">
										<?php
										if (get_field('pb1_ten_phien_ban')) {
										?>
					...
					<div class="accordion-item">
						...
						<div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								...
								?>
									<div class="hp-compare-label">Hệ thống cảnh báo và giảm thiểu va chạm phía trước (FCM)</div>
									<div class="row gx-5 justify-content-center">
										<?php
										if (get_field('pb1_ten_phien_ban')) {
										?>
								...
								?>
									<div class="hp-compare-label">Hệ thống cảnh báo phương tiện cắt ngang khi lùi xe (RCTA)</div>
									<div class="row gx-5 justify-content-center">
										<?php
										if (get_field('pb1_ten_phien_ban')) {
										?>
								...
								?>
									<div class="hp-compare-label">Túi khí phía trước dành cho người lái và hành khách</div>
									<div class="row gx-5 justify-content-center">
										<?php
										if (get_field('pb1_ten_phien_ban')) {
										?>
		...
		<div class="row g-0">
			<div class="col-md-4">
				<a href="#" class="hp-service-card">
					<img src="https://www.mitsubishi-motors.com.vn/storage/content/w/wp-content/uploads/2022/05/home-page-promotion.webp?v=2022-08-11-1420" alt="" />
			...
			<div class="col-md-4">
				<a href="#" class="hp-service-card">
					<img src="https://www.mitsubishi-motors.com.vn/storage/content/w/wp-content/uploads/2022/05/home-page-maintenance.webp?v=2022-08-11-1420" alt="" />
					<div class="hp-sc-body">
						<h2>Bảo dưỡng</h2>
			...
			<div class="col-md-4">
				<a href="#" class="hp-service-card">
					<img src="https://www.mitsubishi-motors.com.vn/storage/content/w/wp-content/uploads/2022/05/home-page-dealer.webp?v=2022-08-11-1420" alt="" />
					<div class="hp-sc-body">
						<h2>Nhà Phân Phối</h2>
	...
	<div class="hp-sect-news">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<a href="#" class="hp-news-item-full">
						<div class="row g-0">
							...
							<div class="col-lg-6">
								<div class="image">
									<img src="https://www.mitsubishi-motors.com.vn/storage/content/w/wp-content/uploads/2020/04/newtriton-banner-mobile.webp?v=2022-08-11-1420" alt="" />
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-lg-4">
					<a href="#" class="hp-news-item-highlight" style="background-image: url(https://www.mitsubishi-motors.com.vn/storage/content/w/wp-content/uploads/2020/01/mitsubishi-thong-tin-trieu-hoi-thumbnail.webp?v=2022-08-11-1420);">
						<div class="hp-ni-content">
							<div class="date">Thứ 4, 22 Tháng ba 2017</div>
							<div class="title">BTC cân nhắc điều chỉnh thuế TTĐB đối với xe bán tải lên 60%
							</div>
